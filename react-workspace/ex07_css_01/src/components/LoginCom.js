...
`;
const LoginCom = ( {onSubmit, onChange, username, password} ) => {
    return (<AuthBlock>
        <LoginBox>
            ...
            <StyledForm onSubmit={onSubmit}>
                <StyledInput name="username" value={username} placeholder="input username" onChange={onChange}/>
                <StyledInput type="password" name="password" value={password} placeholder="input password" onChange={onChange}/>
<StyledButton type="submit" width="100%" background={["178,235,244",0.5]}>로그인</StyledButton>
            </StyledForm>
        </LoginBox>
    </AuthBlock>)
}
